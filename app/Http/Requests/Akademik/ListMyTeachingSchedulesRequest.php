...
/**
 * GET /my-teaching-schedules?academic_year_id&semester — Jadwal Saya. Both
 * optional together; omitting both falls back to the active academic year
 * and its active_semester (MyTeachingScheduleService).
 */
class ListMyTeachingSchedulesRequest extends FormRequest
{
