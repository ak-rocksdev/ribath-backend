...
class StudentCompletionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $requiredOrNullable = fn (array $rules) => $isComplete
            ? ['required', ...$rules]
            : ['nullable', ...$rules];
        ...
        return [
            ...
            'education_history.last_school_name' => $requiredOrNullable(['string', 'max:200']),
            'education_history.last_education_level' => $requiredOrNullable(['string', 'in:elementary,middle_school,high_school']),
            ...
            'religious_profile.quran_reading_ability' => $requiredOrNullable(['string', 'in:fluent,basic,unable']),
